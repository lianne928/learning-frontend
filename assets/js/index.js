...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        if (!courses || courses.length === 0) {
            container.innerHTML = '<div class="col-12 text-center text-muted py-5">目前沒有課程資料</div>';
            return;
        }
        ...
        container.innerHTML = '<div class="col-12 text-center text-danger py-5">🚨 無法連線到伺服器</div>';
    }
});